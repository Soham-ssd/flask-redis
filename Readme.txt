create stackdemo directory and go in it create multi node environment by using docker swarm
...
/* rm /usr/bin/docker-compose curl -SL https://github.com/docker/compose/releases/download/v2.17.2/docker-compose-linux-x86_64 -o /usr/local/bin/docker-compose 
